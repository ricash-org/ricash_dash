...
import KycHub from './pages/KycHub'
...
import FundRequestDetailsPage from './pages/FundRequestDetailsPage'
import RoleProtectedRoute from './components/RoleProtectedRoute'
import AgentRegistrationPage from './pages/AgentRegistrationPage'
import AgentRegistrationPending from './pages/AgentRegistrationPending'
      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            <Route path="/register-agent/pending" element={<AgentRegistrationPending />} />
            ...
            <Route path="/app" element={
              ...
              <Route
                path="users/kyc"
                element={
                  <RoleProtectedRoute requiredRoles={["KYC_ADMIN","SUPER_ADMIN"]}>
                    <KycHub />
                  </RoleProtectedRoute>
                }
              />
              ...
              <Route path="funds/request" element={<FundRequestPage />} />
              <Route
                path="funds/approval"
                element={
                  <RoleProtectedRoute requiredRoles={["FUNDS_ADMIN","SUPER_ADMIN"]}>
                    <FundApprovalPage />
                  </RoleProtectedRoute>
                }
              />
              <Route path="funds/requests" element={<Navigate to="/app/funds/approval" replace />} />
              <Route
                path="funds/approval/:id"
                element={
                  <RoleProtectedRoute requiredRoles={["FUNDS_ADMIN","SUPER_ADMIN"]}>
                    <FundRequestDetailsPage />
                  </RoleProtectedRoute>
                }
              />
