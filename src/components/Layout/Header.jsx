      ...
      <div className="flex items-center justify-between max-w-full">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4 flex-1">
          ...
          <MenuButton
            ...
            className="hover:bg-gradient-to-r hover:from-[#2B8286]/10 hover:to-[#B19068]/10 transition-all duration-300 hover:shadow-md"
          />
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          >
            ...
            <RicashDropdownItem 
              className="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 p-4"
